...
//   Copyright 2014-2023 Tardis Technologies. All rights reserved.
// </copyright>
// <summary>
...
namespace OdysseyMvc2023.Models
{
    ...
    public class OdysseyRepository
    {
        ...
        public Dictionary<string, string> Config
        {
            ...
            {
                if (this.config == null)
                    this.Config = Enumerable.ToDictionary<Config, string, string>((IEnumerable<Config>)Queryable.Select<Config, Config>((IQueryable<Config>)this.context.Configs, (Expression<Func<Config, Config>>)(c => c)), (Func<Config, string>)(d => d.Name), (Func<Config, string>)(d => d.Value));
                return this.config;
            }
            private set
            {
        ...
        public Event TournamentInfo
        {
            get
            {
                Event tournamentInfo = this.tournamentInfo;
                if (tournamentInfo == null)
                    tournamentInfo = this.TournamentInfo = Queryable.Where<Event>((IQueryable<Event>)this.context.Events, (Expression<Func<Event, bool>>)(o => o.EventName.StartsWith(this.RegionName) && o.EventName.Contains("Tournament"))).First<Event>();

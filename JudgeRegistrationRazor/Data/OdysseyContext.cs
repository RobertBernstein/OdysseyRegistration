...
namespace JudgeRegistrationRazor.Data;
...
public partial class OdysseyContext : DbContext
{
    ...
    public virtual DbSet<CoachesTrainingDivision> CoachesTrainingDivisions { get; set; }

    public virtual DbSet<CoachesTrainingRegion> CoachesTrainingRegions { get; set; }

    public virtual DbSet<CoachesTrainingRegistration> CoachesTrainingRegistrations { get; set; }

    public virtual DbSet<CoachesTrainingRole> CoachesTrainingRoles { get; set; }

    public virtual DbSet<Config> Configs { get; set; }

    public virtual DbSet<ContactUsRecipient> ContactUsRecipients { get; set; }

    public virtual DbSet<ContactUsSenderRole> ContactUsSenderRoles { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CoachesTrainingRegion>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_coaches_training_regions");

            entity.Property(e => e.Name).HasMaxLength(50);
        });

        modelBuilder.Entity<CoachesTrainingRegistration>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_coaches_training");
        ...
        modelBuilder.Entity<CoachesTrainingRole>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_coaches_training_roles");
        ...
        modelBuilder.Entity<Config>(entity =>
        {
            ...
            entity.HasData(SeedHelper.SeedData<Config>("Config.json"));
        });

        modelBuilder.Entity<ContactUsRecipient>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_contact_us_recipients");
        ...
        modelBuilder.Entity<ContactUsSenderRole>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_contact_us_sender_roles");
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity.HasData(SeedHelper.SeedData<Event>("Events.json"));
        });
        ...
        modelBuilder.Entity<Problem>(entity =>
        {
            ...
            entity.HasData(SeedHelper.SeedData<Problem>("Problem.json"));
        });
